...
@Entity
@Table(
    name = "product_preset_attribute_values",
...
class PresetAttributeValueJpaEntity(
    ...
    @CollectionTable(name = "product_preset_attribute_value_options", joinColumns = [JoinColumn(name = "value_id")])
    ...
    companion object {
        fun fromDomain(domain: ProductAttributeValue): PresetAttributeValueJpaEntity =
            when (val value = domain.value) {
                is AttributeValue.Text ->
                    PresetAttributeValueJpaEntity(
