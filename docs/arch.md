...
## 11. تعدد اللغات AR/EN (متطلب — التفاصيل قصة تانية لاحقاً)

الباك والبرنامج يدعمان العربية والإنجليزية على الأقل. الاتجاه العام (يُفصّل لاحقاً):
أسماء المنتجات/الأصناف (`name_ar`/`name_en`)، رسائل الأخطاء bundles، وتفاوض اللغة عبر `Accept-Language`.
